...
a26 = Actor.create(first_name: "Ellen", last_name: "Page", image: "https://content.codecademy.com/courses/learn-rails/img/ellen-page.jpg", bio: "Ellen Philpotts-Page, known professionally as Ellen Page, is a Canadian actress. She started her career in Canada with roles in the telev...")
...
m5 = Movie.create(title: "Inception", image: "https://content.codecademy.com/courses/learn-rails/img/inception.jpg", release_year: "2010", plot: "Dom Cobb (Leonardo DiCaprio) is a thief with the rare ability to enter people's dreams and steal their secrets from their subconscious ...")
